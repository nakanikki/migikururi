# 右くるり (Win専用右クリックパイメニューソフト)<br>
 ...
 [exeファイルここ](https://github.com/nakanikki/migikururi/releases) [更新履歴](https://github.com/nakanikki/migikururi/blob/main/CHANGELOG.md)<br>
...
- [更新履歴](https://github.com/nakanikki/migikururi/blob/main/CHANGELOG.md)

## クリスタで使用する時の遅延
クリスタは修飾キーと本キーの間に数Fのギャップ時間が入るみたいです。
例えばCtrlとZキーをほぼ同時に送ってもアンドゥは6F後に処理されたりします。なぜそういう仕様なのかはわかりません。
はじめにCtrl入力にするなどして遅延に抗うことができます。この為に最初に実行機能、修飾キー押す/離すアクション機能を追加しました。
<img width="673" height="249" alt="image" src="https://github.com/user-attachments/assets/cf45c715-e41c-41af-9be2-c898fe428073" />
